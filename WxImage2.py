...
panel_y, panel_h = 0.57, 0.32
panel2_h = 0.22

row1_center = 0.58
row2_center = 0.15

compass_cx_frac = 0.24
...
def precip_card(ax, x, y, w, h, min_temp_today):
    ...
    ax.text(x + w/2, y + h - 0.03, "PRECIPITATION (TODAY)", ha='center', va='top',
            fontsize=8, fontweight='bold', color='#777777', transform=ax.transAxes)
...
compass_cy_fig = panel_y + panel_h * row1_center
